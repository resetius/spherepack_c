/* idvtgc.f -- translated by f2c (version 20061008).
...
/*              nlat*(2*nt*nlon+max0(6*l2,nlon)+4*nt*l1+1) */
...
/* Subroutine */ int idvtgc_(integer *nlat, integer *nlon, integer *isym, 
	integer *nt, real *v, real *w, integer *idvw, integer *jdvw, real *ad,
	 real *bd, real *av, real *bv, integer *mdab, integer *ndab, real *
	wvhsgc, integer *lvhsgc, real *work, integer *lwork, real *pertbd, 
	real *pertbv, integer *ierror)
{
...
/*     set work space pointers */
    ...
    idvtgc1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &work[icr], &work[ici], &mmax, &work[is], 
	    mdab, ndab, &ad[ad_offset], &bd[bd_offset], &av[av_offset], &bv[
	    bv_offset], &wvhsgc[1], lvhsgc, &work[iwk], &liwk, &pertbd[1], &
	    pertbv[1], ierror);
    return 0;
} /* idvtgc_ */
...
/* Subroutine */ int idvtgc1_(integer *nlat, integer *nlon, integer *isym, 
	integer *nt, real *v, real *w, integer *idvw, integer *jdvw, real *br,
	 real *bi, real *cr, real *ci, integer *mmax, real *sqnn, integer *
	mdab, integer *ndab, real *ad, real *bd, real *av, real *bv, real *
	wvhsgc, integer *lvhsgc, real *wk, integer *lwk, real *pertbd, real *
...
/*     sythesize br,bi,cr,ci into the vector field (v,w) */
    ...
    vhsgc_(nlat, nlon, &ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &br[
	    ...
	    nlat, &wvhsgc[1], lvhsgc, &wk[1], lwk, ierror);
    return 0;
} /* idvtgc1_ */
