/* ivlapec.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int ivlapec_(integer *nlat, integer *nlon, integer *ityp, 
	...
	integer *mdbc, integer *ndbc, doublereal *wvhsec, integer *lvhsec, 
...
/*     set work space pointers for vector laplacian coefficients */
    ...
    ivlapec1_(nlat, nlon, ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &work[icr], &work[ici], &mmax, &work[ifn], 
	    mdbc, ndbc, &br[br_offset], &bi[bi_offset], &cr[cr_offset], &ci[
	    ci_offset], &wvhsec[1], lvhsec, &work[iwk], &liwk, ierror);
    return 0;
} /* ivlapec_ */
...
/*     sythesize coefs into vector field (v,w) */
    ...
    vhsec_(nlat, nlon, ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    brvw[brvw_offset], &bivw[bivw_offset], &crvw[crvw_offset], &civw[
	    civw_offset], mmax, nlat, &wsave[1], lwsav, &wk[1], lwk, ierror);
    return 0;
} /* ivlapec1_ */
