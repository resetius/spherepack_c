/* vrtgs.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int vrtgs_(integer *nlat, integer *nlon, integer *isym, 
	...
	*ci, integer *mdc, integer *ndc, real *wshsgs, integer *lshsgs, real *
	work, integer *lwork, integer *ierror)
{
    ...
    static integer l1, l2, ia, ib, mn, lp, is, ls, mab, nln, iwk, lwk, imid, 
	    mmax, lpimn;
    extern /* Subroutine */ int vrtgs1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    iwk = is + *nlat;
    lwk = *lwork - (mn << 1) - *nlat;
    vrtgs1_(nlat, nlon, isym, nt, &vort[vort_offset], ivrt, jvrt, &cr[
...
/*     synthesize a,b into vort */
    ...
    shsgs_(nlat, nlon, isym, nt, &vort[vort_offset], ivrt, jvrt, &a[a_offset],
