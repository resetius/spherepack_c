/* vrtec.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int vrtec_(integer *nlat, integer *nlon, integer *isym, 
	...
	*ci, integer *mdc, integer *ndc, real *wshsec, integer *lshsec, real *
	work, integer *lwork, integer *ierror)
{
    ...
    static integer l1, l2, ia, ib, mn, is, ls, mab, nln, iwk, lwk, lzz1, labc,
	     imid, mmax;
    extern /* Subroutine */ int vrtec1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    iwk = is + *nlat;
    lwk = *lwork - (mn << 1) - *nlat;
    vrtec1_(nlat, nlon, isym, nt, &vort[vort_offset], ivrt, jvrt, &cr[
	    cr_offset], &ci[ci_offset], mdc, ndc, &work[ia], &work[ib], &mab, 
	    &work[is], &wshsec[1], lshsec, &work[iwk], &lwk, ierror);
    return 0;
} /* vrtec_ */
...
/* Subroutine */ int vrtec1_(integer *nlat, integer *nlon, integer *isym, 
	...
	*sqnn, real *wshsec, integer *lshsec, real *wk, integer *lwk, integer 
	*ierror)
{
    /* System generated locals */
    integer vort_dim1, vort_dim2, vort_offset, cr_dim1, cr_dim2, cr_offset, 
...
/*     synthesize a,b into vort */
    ...
    shsec_(nlat, nlon, isym, nt, &vort[vort_offset], ivrt, jvrt, &a[a_offset],
	     &b[b_offset], mab, nlat, &wshsec[1], lshsec, &wk[1], lwk, ierror)
	    ;
    return 0;
} /* vrtec1_ */
