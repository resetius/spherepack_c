/* idives.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int idives_(integer *nlat, integer *nlon, integer *isym, 
	...
	real *b, integer *mdab, integer *ndab, real *wvhses, integer *lvhses, 
	real *work, integer *lwork, real *pertrb, integer *ierror)
{
    ...
    /* Local variables */
    static integer mn, is, ibi, ibr, idz, iwk, imid, mmax, liwk, lzimn;
    extern /* Subroutine */ int idves1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    idves1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
...
/* Subroutine */ int idves1_(integer *nlat, integer *nlon, integer *isym, 
	...
	real *a, real *b, real *wsav, integer *lwsav, real *wk, integer *lwk, 
...
/*     vector sythesize br,bi into irrotational (v,w) */
    ...
    vhses_(nlat, nlon, &ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &br[
	    br_offset], &bi[bi_offset], &cr, &ci, mmax, nlat, &wsav[1], lwsav,
	     &wk[1], lwk, ierror);
    return 0;
} /* idves1_ */
