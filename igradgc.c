/* igradgc.f -- translated by f2c (version 20061008).
...
/*     set work space pointers */
    ...
    igrdgc1_(nlat, nlon, isym, nt, &sf[sf_offset], isf, jsf, &work[ia], &work[
	    ib], &mab, &work[is], mdb, ndb, &br[br_offset], &bi[bi_offset], &
	    wshsgc[1], lshsgc, &work[iwk], &liwk, ierror);
    return 0;
} /* igradgc_ */
...
/*     scalar sythesize a,b into sf */
    ...
    shsgc_(nlat, nlon, isym, nt, &sf[sf_offset], isf, jsf, &a[a_offset], &b[
