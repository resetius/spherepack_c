...
/* Subroutine */ int shagc_(integer *nlat, integer *nlon, integer *isym, 
	...
	integer *mdab, integer *ndab, real *wshagc, integer *lshagc, real *
...
/* Subroutine */ int shagc1_(integer *nlat, integer *nlon, integer *l, 
	...
	real *wts, real *wfft, integer *late, real *pmn, real *g)
{
    /* System generated locals */
    ...
    extern /* Subroutine */ int legin_(integer *, integer *, integer *, 
	    integer *, real *, real *, integer *), hrfftf_(integer *, integer 
...
/* Subroutine */ int shagci_(integer *nlat, integer *nlon, real *wshagc, 
