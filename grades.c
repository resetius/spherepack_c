/* grades.f -- translated by f2c (version 20061008).
...
/*     set work space pointers */
    ...
    grades1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &mmax, &work[is], mdab, ndab, &a[a_offset],
	     &b[b_offset], &wvhses[1], lvhses, &work[iwk], &liwk, ierror);
    return 0;
} /* grades_ */
...
/* Subroutine */ int grades1_(integer *nlat, integer *nlon, integer *isym, 
	...
	real *a, real *b, real *wvhses, integer *lvhses, real *wk, integer *
	lwk, integer *ierror)
{
    /* System generated locals */
...
/*     vector sythesize br,bi into (v,w) (cr,ci are dummy variables) */
    ...
    vhses_(nlat, nlon, &ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &br[
	    br_offset], &bi[bi_offset], &cr, &ci, mmax, nlat, &wvhses[1], 
	    lvhses, &wk[1], lwk, ierror);
    return 0;
} /* grades1_ */
