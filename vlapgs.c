/* vlapgs.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int vlapgs_(integer *nlat, integer *nlon, integer *ityp, 
	...
	doublereal *ci, integer *mdbc, integer *ndbc, doublereal *wvhsgs, 
	integer *lvhsgs, doublereal *work, integer *lwork, integer *ierror)
{
...
/*     set work space pointers for vector laplacian coefficients */
    ...
    vlapgs1_(nlat, nlon, ityp, nt, &vlap[vlap_offset], &wlap[wlap_offset], 
	    idvw, jdvw, &work[ibr], &work[ibi], &work[icr], &work[ici], &mmax,
	     &work[ifn], mdbc, ndbc, &br[br_offset], &bi[bi_offset], &cr[
	    cr_offset], &ci[ci_offset], &wvhsgs[1], lvhsgs, &work[iwk], &liwk,
	     ierror);
    return 0;
} /* vlapgs_ */
...
/*     sythesize coefs into vector field (vlap,wlap) */
    ...
    vhsgs_(nlat, nlon, ityp, nt, &vlap[vlap_offset], &wlap[wlap_offset], idvw,
