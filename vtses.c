/* vtses.f -- translated by f2c (version 20061008).
...
/*     dwork  a double precision work array that does have to be saved. */
...
/* Computing MIN */
    ...
    *ierror = 0;
    ...
    jw1 = lzimn + 1;
    jw2 = jw1 + lzimn;
    vtses1_(nlat, nlon, ityp, nt, &imid, idvw, jdvw, &vt[vt_offset], &wt[
...
/* Subroutine */ int vtsesi_(integer *nlat, integer *nlon, real *wvts, 
	...
	integer *ldwork, integer *ierror)
{
    ...
    extern /* Subroutine */ int vet1_(integer *, integer *, integer *, real *,
	     real *, integer *, real *, real *, doublereal *);
...
/* Computing MAX */
    ...
    *ierror = 0;
    iw1 = *nlat * 3 * imid + 1;
    idz = mmax * (*nlat + *nlat - mmax + 1) / 2;
    vet1_(nlat, nlon, &imid, &wvts[1], &wvts[lzimn + 1], &idz, &work[1], &
	    work[iw1], &dwork[1]);
    hrffti_(nlon, &wvts[(lzimn << 1) + 1]);
    return 0;
} /* vtsesi_ */

/* Subroutine */ int vet1_(integer *nlat, integer *nlon, integer *imid, real *
	vb, real *wb, integer *idz, real *vin, real *wzvin, doublereal *dwork)
{
    /* System generated locals */
    ...
    static integer mmax;
    extern /* Subroutine */ int vtinit_(integer *, integer *, real *, 
	    doublereal *), wtinit_(integer *, integer *, real *, doublereal *)
	    ;
...
/* Computing MIN */
    i__1 = *nlat, i__2 = (*nlon + 1) / 2;
    mmax = min(i__1,i__2);
    vtinit_(nlat, nlon, &wzvin[1], &dwork[1]);
    i__1 = mmax;
...
/* L33: */
    ...
    wtinit_(nlat, nlon, &wzvin[1], &dwork[1]);
    i__3 = mmax;
