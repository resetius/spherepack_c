/* idvtes.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int idvtes_(integer *nlat, integer *nlon, integer *isym, 
	...
	wvhses, integer *lvhses, real *work, integer *lwork, real *pertbd, 
	real *pertbv, integer *ierror)
{
    ...
    static integer mn, is, ibi, ici, ibr, icr, idz, iwk, imid, mmax, liwk, 
	    lzimn;
    extern /* Subroutine */ int idvtes1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    idvtes1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &work[icr], &work[ici], &mmax, &work[is], 
	    mdab, ndab, &ad[ad_offset], &bd[bd_offset], &av[av_offset], &bv[
	    bv_offset], &wvhses[1], lvhses, &work[iwk], &liwk, &pertbd[1], &
	    pertbv[1], ierror);
    return 0;
} /* idvtes_ */
...
/* Subroutine */ int idvtes1_(integer *nlat, integer *nlon, integer *isym, 
	...
	widvtes, integer *lidvtes, real *wk, integer *lwk, real *pertbd, real 
...
/*     sythesize br,bi,cr,ci into the vector field (v,w) */
    ...
    vhses_(nlat, nlon, &ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &br[
	    ...
	    nlat, &widvtes[1], lidvtes, &wk[1], lwk, ierror);
    return 0;
} /* idvtes1_ */
