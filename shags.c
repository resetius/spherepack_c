...
/* Subroutine */ int shags_(integer *nlat, integer *nlon, integer *mode, 
	...
	integer *mdab, integer *ndab, real *wshags, integer *lshags, real *
	work, integer *lwork, integer *ierror)
{
    ...
    /* Local variables */
    static integer l, l1, l2, lp, iw, lat, late, ifft, ipmn, iwts;
...
/* Subroutine */ int shags1_(integer *nlat, integer *nlon, integer *l, 
	...
	integer *nt, real *a, real *b, integer *mdab, integer *ndab, real *
	wts, real *wfft, real *pmn, integer *late, real *g, real *work)
{
    /* System generated locals */
    ...
    static real t1, t2;
    static integer mn, is, ms, ns, lm1, nl2, lp1, mp1, np1, mp2;
    static real sfn;
    static integer mml1;
...
/* Subroutine */ int shagsi_(integer *nlat, integer *nlon, real *wshags, 
	integer *lshags, real *work, integer *lwork, doublereal *dwork, 
	integer *ldwork, integer *ierror)
{
    ...
    extern /* Subroutine */ int shagsp_(integer *, integer *, real *, integer 
	    *, doublereal *, integer *, integer *), shagss1_(integer *, 
...
/* Subroutine */ int shagss1_(integer *nlat, integer *l, integer *late, real *
...
/* Subroutine */ int shagsp_(integer *nlat, integer *nlon, real *wshags, 
