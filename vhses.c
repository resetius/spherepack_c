...
/* Subroutine */ int vhsesi_(integer *nlat, integer *nlon, real *wvhses, 
	integer *lvhses, real *work, integer *lwork, doublereal *dwork, 
	integer *ldwork, integer *ierror)
{
    ...
    extern /* Subroutine */ int ves1_(integer *, integer *, integer *, real *,
...
/* Subroutine */ int ves1_(integer *nlat, integer *nlon, integer *imid, real *
	vb, real *wb, integer *idz, real *vin, real *wzvin, doublereal *dwork)
{
    ...
    static integer mmax;
    extern /* Subroutine */ int vbinit_(integer *, integer *, real *, 
	    doublereal *), wbinit_(integer *, integer *, real *, doublereal *)
	    ;
