...
/* Subroutine */ int vhseci_(integer *nlat, integer *nlon, real *wvhsec, 
	integer *lvhsec, doublereal *dwork, integer *ldwork, integer *ierror)
{
    ...
    extern /* Subroutine */ int hrffti_(integer *, real *), vbinit_(integer *,
	     integer *, real *, doublereal *), wbinit_(integer *, integer *, 
	    real *, doublereal *);
