/* isfvpgc.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int isfvpgc_(integer *nlat, integer *nlon, integer *isym, 
	...
	integer *mdb, integer *ndb, doublereal *wvhsgc, integer *lvhsgc, 
...
/*     synthesize br,bi,cr,ci into (v,w) */
    ...
    vhsgc_(nlat, nlon, &ityp, nt, &v[v_offset], &w[w_offset], idv, jdv, &br[
