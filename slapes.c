/* slapes.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int slapes_(integer *nlat, integer *nlon, integer *isym, 
	...
	*a, doublereal *b, integer *mdab, integer *ndab, doublereal *wshses, 
...
/*     set work space pointers */
    ...
    iwk = ifn + *nlat;
    lwk = *lwork - (mn << 1) - *nlat;
    slapes1_(nlat, nlon, isym, nt, &slap[slap_offset], ids, jds, &a[a_offset],
...
/*     synthesize alap,blap into slap */
    ...
    shses_(nlat, nlon, isym, nt, &slap[slap_offset], ids, jds, &alap[
