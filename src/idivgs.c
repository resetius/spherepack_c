/* idivgs.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int idivgs_(integer *nlat, integer *nlon, integer *isym, 
	...
	doublereal *wvhsgs, integer *lvhsgs, doublereal *work, integer *lwork,
	 doublereal *pertrb, integer *ierror)
{
    ...
    /* Local variables */
    integer l1, l2, mn, is, ibi, ibr, idz, iwk, imid, mmax, liwk, lwmin, 
	    lzimn;
    extern /* Subroutine */ int idvgs1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    idvgs1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &mmax, &work[is], mdab, ndab, &a[a_offset],
	     &b[b_offset], &wvhsgs[1], lvhsgs, &work[iwk], &liwk, &pertrb[1], 
	    ierror);
    return 0;
} /* idivgs_ */
