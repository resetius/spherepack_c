/* visgau.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int visgau_(integer *nlat, integer *nlon, doublereal *h__, 
	integer *len, doublereal *eyer, doublereal *eyelat, doublereal *
	eyelon, doublereal *theta, doublereal *wk, integer *lwk, integer *iwk,
	 integer *liwk, integer *ierror)
{
    ...
    integer i__, j, m, n;
    doublereal pi;
    integer mn, nx, ny, nz, nw1, nw2, nx1, ny1, nz1, nx2, ny2, nz2, nx3, ny3, 
	    nz3;
    doublereal dtr;
    integer nxp, nyp;
    static /* Subroutine */ int diag_(integer *, integer *, doublereal *, 
	    doublereal *, integer *);
    integer itri;
    ...
    doublereal zeye;
    integer nwrk, nmst;
    static /* Subroutine */ int embed_(integer *, integer *, doublereal *, 
	    integer *, doublereal *);
    integer nmfac, nclat;
    static /* Subroutine */ int sptcg_(doublereal *, integer *, integer *, 
    ...
    integer niflag;
    static /* Subroutine */ int stride_(integer *, integer *, integer *, 
	    integer *), trigau_(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, integer *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *, integer *, 
	    integer *), projct_(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *), intrpg_(doublereal *, 
...
/*     theta  a double precision  array with nlat gauss colatitudes */
...
/*     **** embed h in a larger array */
    embed_(nlat, nlon, &h__[h_offset], len, &wk[nz1]);
/*     ****     mid-cell interpolation */
    intrpg_(&wk[nz1], &m, &n, &wk[nw1], &wk[nw2], &iwk[niflag]);
/*     ****     transform grid points to cartesian coordinates */
    sptcg_(&wk[nz1], &m, &n, &theta[1], &wk[nclat], &wk[nslat], &wk[nx], &wk[
	    ny], &wk[nz]);
...
/*     ****     perform triangulation */
    trigau_(&m, &n, &wk[nx], &wk[ny], &wk[nz], &itri, &wk[nx1], &wk[ny1], &wk[
...
/* Subroutine */ static int embed_(integer *nlat, integer *nlon, doublereal *h__, 
	integer *len, doublereal *hg)
{
    /* System generated locals */
    integer h_dim1, h_offset, hg_dim1, hg_offset, i__1, i__2;

    /* Local variables */
    integer i__, j;
    doublereal sumn, sums;
	...
	i__2 = *nlon;
	for (j = 1; j <= i__2; ++j) {
	    hg[i__ + 1 + j * hg_dim1] = h__[i__ + j * h_dim1];
/* L10: */
	}
    }
    sumn = 0.;
...
/* L15: */
    ...
    for (j = 1; j <= i__2; ++j) {
	hg[j * hg_dim1 + 1] = sumn;
	hg[*nlat + 2 + j * hg_dim1] = sums;
/* L20: */
    }
    i__2 = *nlat + 2;
    for (i__ = 1; i__ <= i__2; ++i__) {
	hg[i__ + (*nlon + 1) * hg_dim1] = hg[i__ + hg_dim1];
/* L25: */
    }
    return 0;
} /* embed_ */

/* Subroutine */ static int intrpg_(doublereal *h__, integer *m, integer *n, 
...
/* Subroutine */ static int sptcg_(doublereal *r__, integer *m, integer *n, 
	doublereal *theta, doublereal *clat, doublereal *slat, doublereal *x, 
	doublereal *y, doublereal *z__)
{
    ...
    /* Local variables */
    integer i__, j;
    doublereal dp, pi, clon, thet, slon;
...
/* Subroutine */ static int diag_(integer *m, integer *n, doublereal *xp, doublereal 
	*yp, integer *iflag)
{
    /* System generated locals */
...
/* Subroutine */ static int stride_(integer *m, integer *n, integer *mst, integer *
	mfac)
{
    /* Initialized data */
...
/* Subroutine */ static int trigau_(integer *m, integer *n, doublereal *x, 
...
/* Subroutine */ static int vsurf_(doublereal *xeye, doublereal *yeye, doublereal *
	...
	integer *iwork)
{
    static /* Subroutine */ int vsurf1_(doublereal *, doublereal *, 
...
/* Subroutine */ static int vsurf1_(doublereal *xeye, doublereal *yeye, doublereal *
	zeye, integer *ntri, doublereal *x1, doublereal *y1, doublereal *z1, 
	doublereal *x2, doublereal *y2, doublereal *z2, doublereal *x3, 
	...
	ifinal)
{
    ...
    integer ityp, irmp1;
    static /* Subroutine */ int frame_(void);
    doublereal cprod, thold;
    integer nsegp, irmax;
    doublereal fntri;
    integer isize;
    static /* Subroutine */ int prjct_(integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
...
/* L87: */
    ...
    pmin *= 1.1;
    pmax *= 1.1;
    set_(&c_b73, &c_b74, &c_b73, &c_b74, &pmin, &pmax, &pmin, &pmax, &c__1);
/* Computing MIN */
...
/* Subroutine */ static int prjct_(integer *init, doublereal *xeye, doublereal *yeye,
...
/* Subroutine */ static int projct_(integer *m, integer *n, doublereal *xeye, 
	...
	doublereal *z__, doublereal *px, doublereal *py)
{
    ...
    /* Local variables */
    integer i__, j;
    doublereal rdum1, rdum2, rdum3, rdum4, rdum5;
    static /* Subroutine */ int prjct_(integer *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *);
