...
/* Subroutine */ int shses_(integer *nlat, integer *nlon, integer *isym, 
	...
	integer *mdab, integer *ndab, real *wshses, integer *lshses, real *
	work, integer *lwork, integer *ierror)
{
    ...
    extern /* Subroutine */ int shses1_(integer *, integer *, integer *, real 
...
/* Subroutine */ int shses1_(integer *nlat, integer *isym, integer *nt, real *
	g, integer *idgs, integer *jdgs, real *a, real *b, integer *mdab, 
	integer *ndab, real *p, integer *imid, integer *idg, integer *jdg, 
...
/* Subroutine */ int shsesi_(integer *nlat, integer *nlon, real *wshses, 
	integer *lshses, real *work, integer *lwork, doublereal *dwork, 
	integer *ldwork, integer *ierror)
{
    ...
    /* Local variables */
    static integer iw1;
    extern /* Subroutine */ int ses1_(integer *, integer *, integer *, real *,
