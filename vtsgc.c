/* vtsgc.f -- translated by f2c (version 20061008).
	...
	wvts, integer *lwvts, real *work, integer *lwork, integer *ierror)
{
    ...
    static integer iw1, iw2, iw3, iw4, iw5, jw1, jw2, idv, lnl, ist, lzz1, 
	    labc, imid, mmax;
    extern /* Subroutine */ int vtsgc1_(integer *, integer *, integer *, 
...
/* Computing MAX */
    ...
    jw1 = lwzvin + 1;
    jw2 = jw1 + lwzvin;
    vtsgc1_(nlat, nlon, ityp, nt, &imid, idvw, jdvw, &vt[vt_offset], &wt[
...
/* Subroutine */ int vtsgc1_(integer *nlat, integer *nlon, integer *ityp, 
	...
	real *vb, real *wb, real *wvbin, real *wwbin, real *wrfft)
{
    /* System generated locals */
    integer vt_dim1, vt_dim2, vt_offset, wt_dim1, wt_dim2, wt_offset, br_dim1,
	     br_dim2, br_offset, bi_dim1, bi_dim2, bi_offset, cr_dim1, 
...
/* Subroutine */ int vtsgci_(integer *nlat, integer *nlon, real *wvts, 
	integer *lwvts, doublereal *dwork, integer *ldwork, integer *ierror)
{
    ...
    /* Local variables */
    static integer iw1, iw2, lzz1, labc;
    extern /* Subroutine */ int gaqd_(integer *, doublereal *, doublereal *, 
	    doublereal *, integer *, integer *);
    static integer imid, ldwk, mmax, ierr;
...
/*     call gaqd(nlat,work,work(2*nlat+1),work(4*nlat+1),lwork,ierr) */
    ldwk = 1;
    gaqd_(nlat, &dwork[1], &dwork[*nlat + 1], &dwork[(*nlat << 1) + 1], &ldwk,
	     &ierr);
    *ierror = 5;
    if (ierr != 0) {
	return 0;
...
/*     call vtgint (nlat,nlon,work,wvts,work(4*nlat+1)) */
    vtgint_(nlat, nlon, &dwork[1], &wvts[1], &dwork[(*nlat << 1) + 1]);
    lwvbin = lzz1 + labc;
    iw1 = lwvbin + 1;
/*     call wtgint (nlat,nlon,work,wvts(iw1),work(4*nlat+1)) */
    wtgint_(nlat, nlon, &dwork[1], &wvts[iw1], &dwork[(*nlat << 1) + 1]);
    iw2 = iw1 + lwvbin;
