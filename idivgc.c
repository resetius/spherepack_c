/* idivgc.f -- translated by f2c (version 20061008).
	...
	real *work, integer *lwork, real *pertrb, integer *ierror)
{
    ...
    static integer l1, l2, mn, is, ibi, ibr, idz, iwk, imid, mmax, liwk, 
	    lwmin, lzimn;
    extern /* Subroutine */ int idvgc1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    idvgc1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
