/* ivrtec.f -- translated by f2c (version 20061008).
	 ...
	 doublereal *pertrb, integer *ierror)
{
    ...
    /* Local variables */
    static integer mn, is, ici, icr, iwk, lzz1, labc, imid, mmax, liwk;
    extern /* Subroutine */ int ivtec1_(integer *, integer *, integer *, 
...
/*     set work space pointers */
    ...
    ivtec1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
