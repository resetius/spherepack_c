/* ivlapgs.f -- translated by f2c (version 20061008).
...
/* Subroutine */ int ivlapgs_(integer *nlat, integer *nlon, integer *ityp, 
	...
	wvhsgs, integer *lvhsgs, real *work, integer *lwork, integer *ierror)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ivlapgs1_(integer *, integer *, integer *, 
...
/*     set work space pointers for vector laplacian coefficients */
    ...
    ivlapgs1_(nlat, nlon, ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &work[icr], &work[ici], &mmax, &work[ifn], 
	    mdbc, ndbc, &br[br_offset], &bi[bi_offset], &cr[cr_offset], &ci[
	    ci_offset], &wvhsgs[1], lvhsgs, &work[iwk], &liwk, ierror);
    return 0;
} /* ivlapgs_ */
...
/* Subroutine */ int ivlapgs1_(integer *nlat, integer *nlon, integer *ityp, 
	...
	real *wsave, integer *lsave, real *wk, integer *lwk, integer *ierror)
{
    /* System generated locals */
...
/*     sythesize coefs into vector field (v,w) */
    ...
    vhsgs_(nlat, nlon, ityp, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
