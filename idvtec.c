/* idvtec.f -- translated by f2c (version 20061008).
...
/*                nlat*(2*nt*nlon+max0(6*l2,nlon)) + nlat*(4*l1*nt+1) */
...
/* Subroutine */ int idvtec_(integer *nlat, integer *nlon, integer *isym, 
	...
	wvhsec, integer *lvhsec, real *work, integer *lwork, real *pertbd, 
...
/*     set work space pointers */
    ...
    idvtec1_(nlat, nlon, isym, nt, &v[v_offset], &w[w_offset], idvw, jdvw, &
	    work[ibr], &work[ibi], &work[icr], &work[ici], &mmax, &work[is], 
	    mdab, ndab, &ad[ad_offset], &bd[bd_offset], &av[av_offset], &bv[
	    bv_offset], &wvhsec[1], lvhsec, &work[iwk], &liwk, &pertbd[1], &
	    pertbv[1], ierror);
    return 0;
} /* idvtec_ */
...
/* Subroutine */ int idvtec1_(integer *nlat, integer *nlon, integer *isym, 
	...
	wvhsec, integer *lvhsec, real *wk, integer *lwk, real *pertbd, real *
